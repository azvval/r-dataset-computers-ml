# main.R — single-file analysis for r-dataset-computers-ml
# Author: Azra Şevval Küpeli
# Date: 2026-06-19
# Description: Single-file analysis of the 'Computers' dataset:
# data loading, preprocessing, EDA, k-means clustering, KNN, Naive Bayes, Decision Tree.
# Usage:
#  - Run interactively in R/RStudio or:
#      Rscript main.R
